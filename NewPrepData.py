# Hi Professor Liu! In this routine, I adjust the error values in each of the bands below, that is the biggest purpose of this routine.
#!/usr/bin/python
import math
import fileinput
import sys
...
output_file = open('eazyerr_CANDELS.cat','w')
...
for line in data.readlines():
    if not line.startswith(('#')):
        ...
        n_ctioU= (((fctioU*.03)**2)+(errctioU**2))**.5
        n_vimosU=(((fvimosU*.03)**2)+(errvimosU**2))**.5
        n_435=(((f435*.03)**2)+(err435**2))**.5
        n_606=(((f606*.03)**2)+(err606**2))**.5
        n_775=(((f775*.03)**2)+(err775**2))**.5
        n_850=(((f850*.03)**2)+(err850**2))**.5
        n_980=(((f980*.03)**2)+(err980**2))**.5
        n_1050=(((f1050*.03)**2)+(err1050**2))**.5
        n_1250=(((f1250*.03)**2)+(err1250**2))**.5
        n_1600=(((f1600*.03)**2)+(err1600**2))**.5
        n_isaack=(((fisaack*.03)**2)+(errisaack**2))**.5
        n_hawkk=(((fhawkik*.03)**2)+(errhawkk**2))**.5
        n_3600=(((f3600*.08)**2)+(err3600**2))**.5
        n_4500=(((f4500*.08)**2)+(err4500**2))**.5
        n_5800=(((f5800*.08)**2)+(err5800**2))**.5
        n_8000=(((f8000*.08)**2)+(err8000**2))**.5
