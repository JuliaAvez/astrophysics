...
output_file = open('eazyerr2_CANDELS.cat','w')
...
for line in data.readlines():
    if not line.startswith(('#')):
        ...
        n_ctioU= (((fctioU*.1)**2)+(errctioU**2))**.5
        n_vimosU=(((fvimosU*.1)**2)+(errvimosU**2))**.5
        n_435=(((f435*.1)**2)+(err435**2))**.5
        n_606=(((f606*.1)**2)+(err606**2))**.5
        n_775=(((f775*.1)**2)+(err775**2))**.5
        n_850=(((f850*.1)**2)+(err850**2))**.5
        n_980=(((f980*.1)**2)+(err980**2))**.5
        n_1050=(((f1050*.1)**2)+(err1050**2))**.5
        n_1250=(((f1250*.1)**2)+(err1250**2))**.5
        n_1600=(((f1600*.1)**2)+(err1600**2))**.5
        n_isaack=(((fisaack*.1)**2)+(errisaack**2))**.5
        n_hawkk=(((fhawkik*.1)**2)+(errhawkk**2))**.5
