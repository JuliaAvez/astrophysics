...
output_file = open('eazyerr13_CANDELS.cat','w')
...
for line in data.readlines():
    if not line.startswith(('#')):
        ...
        n_ctioU= (((fctioU*.04)**2)+(errctioU**2))**.5
        n_vimosU=(((fvimosU*.04)**2)+(errvimosU**2))**.5
        n_435=(((f435*.04)**2)+(err435**2))**.5
        n_606=(((f606*.04)**2)+(err606**2))**.5
        n_775=(((f775*.04)**2)+(err775**2))**.5
        n_850=(((f850*.04)**2)+(err850**2))**.5
        n_980=(((f980*.04)**2)+(err980**2))**.5
        n_1050=(((f1050*.04)**2)+(err1050**2))**.5
        n_1250=(((f1250*.04)**2)+(err1250**2))**.5
        n_1600=(((f1600*.04)**2)+(err1600**2))**.5
        n_isaack=(((fisaack*.15)**2)+(errisaack**2))**.5
        n_hawkk=(((fhawkik*.15)**2)+(errhawkk**2))**.5
        n_3600=(((f3600*.25)**2)+(err3600**2))**.5
        n_4500=(((f4500*.25)**2)+(err4500**2))**.5
        n_5800=(((f5800*.25)**2)+(err5800**2))**.5
        n_8000=(((f8000*.25)**2)+(err8000**2))**.5
