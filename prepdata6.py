...
output_file = open('eazyerr6_CANDELS.cat','w')
...
for line in data.readlines():
    if not line.startswith(('#')):
        ...
        n_3600=(((f3600*.20)**2)+(err3600**2))**.5
        n_4500=(((f4500*.20)**2)+(err4500**2))**.5
        n_5800=(((f5800*.20)**2)+(err5800**2))**.5
        n_8000=(((f8000*.20)**2)+(err8000**2))**.5
