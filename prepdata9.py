...
output_file = open('eazyerr9_CANDELS.cat','w')
...
for line in data.readlines():
    if not line.startswith(('#')):
        ...
        n_ctioU= (((fctioU*.01)**2)+(errctioU**2))**.5
        n_vimosU=(((fvimosU*.01)**2)+(errvimosU**2))**.5
        n_435=(((f435*.01)**2)+(err435**2))**.5
        n_606=(((f606*.01)**2)+(err606**2))**.5
        n_775=(((f775*.01)**2)+(err775**2))**.5
        n_850=(((f850*.01)**2)+(err850**2))**.5
        n_980=(((f980*.01)**2)+(err980**2))**.5
        n_1050=(((f1050*.01)**2)+(err1050**2))**.5
        n_1250=(((f1250*.01)**2)+(err1250**2))**.5
        n_1600=(((f1600*.01)**2)+(err1600**2))**.5
